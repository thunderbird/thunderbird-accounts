  ...
  <div class="form-container">
    ...
    <div class="container">
      <div>
        ...
        <form
          id="delete-app-password-form"
          ref="deleteAppPasswordFormRef"
          method="post"
          action="/self-serve/app-passwords/remove"
        >
      ...
      <div>
        ...
        <form
          id="new-app-password-form"
          ref="newAppPasswordFormRef"
          name="addForm"
          method="post"
          action="/self-serve/app-passwords/add"
          v-if="appPasswords?.length === 0"
        >
          <text-input name="name" data-testid="app-passwords-add-name-input">Name</text-input>
          <text-input name="password" data-testid="app-passwords-add-password-input" type="password"
            >Password</text-input
          >
