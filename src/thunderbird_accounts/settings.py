...
STALWART_ADMIN_API_USE_JMAP = os.getenv('STALWART_ADMIN_API_USE_JMAP', '').lower() == 'true'
STALWART_JMAP_API_URL = os.getenv('STALWART_JMAP_API_URL')
STALWART_JMAP_API_AUTH_USER = os.getenv('STALWART_JMAP_API_AUTH_USER')
STALWART_JMAP_API_AUTH_SECRET = os.getenv('STALWART_JMAP_API_AUTH_SECRET')
STALWART_JMAP_API_AUTH_METHOD = os.getenv('STALWART_JMAP_API_AUTH_METHOD')
STALWART_JMAP_API_IGNORE_API_URL: bool = os.getenv('STALWART_JMAP_API_IGNORE_API_URL', '').lower() == 'true'
STALWART_ALIAS_UPDATE_LOCK_TIMEOUT = 30
STALWART_ALIAS_UPDATE_LOCK_BLOCKING_TIMEOUT = 30
