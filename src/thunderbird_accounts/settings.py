...
ZENDESK_APP_AUDIENCE: str = os.getenv('ZENDESK_APP_AUDIENCE')
ZENDESK_APP_PUBLIC_KEY: str = os.getenv('ZENDESK_APP_PUBLIC_KEY')
ZENDESK_OAUTH_CLIENT_ID: str = os.getenv('ZENDESK_OAUTH_CLIENT_ID')
ZENDESK_OAUTH_AUDIENCE: str = os.getenv('ZENDESK_OAUTH_AUDIENCE')
ZENDESK_OAUTH_ISSUER: str = os.getenv('ZENDESK_OAUTH_ISSUER')
ZENDESK_OAUTH_JWKS_ENDPOINT: str = os.getenv('ZENDESK_OAUTH_JWKS_ENDPOINT')
