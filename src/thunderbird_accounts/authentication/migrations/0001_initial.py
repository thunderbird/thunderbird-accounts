...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'abstract': False,
                'indexes': [models.Index(fields=['uuid'], name='authenticat_uuid_a61415_idx'), models.Index(fields=['created_at'], name='authenticat_created_b28532_idx'), models.Index(fields=['updated_at'], name='authenticat_updated_f1ba1a_idx'), models.Index(fields=['timezone'], name='authenticat_timezon_418139_idx')],
            },
            managers=[
